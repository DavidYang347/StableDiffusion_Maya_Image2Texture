...
def generateWithPayload(payload, outputDir, url="127.0.0.1:7860", endpoint="/sdapi/v1/txt2img"):
...
def mergeCompositeShaderToImage(compositeShader, mergedShader):
    ...
    # Your code snippet
    images_data = rt.getLayeredTextureImages(layeredTexture) #get many textureimages
    images_data.reverse()
    result_image = rt.overlay_images(images_data)  # merge them together
    ...
    result_image.save(mergedPath) # save image
