...
from cgm.tools.stableDiffusion import OneClickGenerateTexture as ocgt
...
class ui(cgmUI.cgmGUI):
    ...
    def buildColumn_project(self, parent, asScroll=False):
        ...
        mc.setParent(_inside)
        cgmUI.add_Header("One Click Texture Generation")
        

        #Four-view Depth/Normal Map button
        _row = mUI.MelHSingleStretchLayout(_inside, expand=True, ut="cgmUISubTemplate")
        mUI.MelSpacer(_row, w=5)
        mUI.MelLabel(_row, l="Four-view angles:", align="right")
        self.uiFourView_angle1 = mUI.MelIntField(
            _row,
            minValue=0,
            value=90,
            changeCommand=cgmGEN.Callback(self.uiFunc_setSize, "field"),
            annotation="angle1",)
        self.uiFourView_angle2 = mUI.MelIntField(
            _row,
            minValue=0,
            value=90,
            changeCommand=cgmGEN.Callback(self.uiFunc_setSize, "field"),
            annotation="angle2",)
        self.uiFourView_angle3 = mUI.MelIntField(
            _row,
            minValue=0,
            value=90,
            changeCommand=cgmGEN.Callback(self.uiFunc_setSize, "field"),
            annotation="angle3",)
        self.uiFourView_angle4 = mUI.MelIntField(
            _row,
            minValue=0,
            value=90,
            changeCommand=cgmGEN.Callback(self.uiFunc_setSize, "field"),
        ...
        mUI.MelLabel(_row, l="Generate Four-view Depth/Normal Maps:", align="right")
        
        cgmUI.add_Button(
            _row,
            "Four-view Depth/Normal Map",
            lambda *a: self.uiFunc_getLatentDepthMap())
        mUI.MelSpacer(_row, w=5)
        _row.layout()
        
        
        #Generate Four-View Image button
        _row = mUI.MelHSingleStretchLayout(_inside, expand=True, ut="cgmUISubTemplate")
        mUI.MelSpacer(_row, w=5)
        mUI.MelLabel(_row, l="ControlNet Generate FourView Size:", align="right")
        self.uiFourView_Width = mUI.MelIntField(
            _row,
            minValue=32,
            value=1024,
            changeCommand=cgmGEN.Callback(self.uiFunc_setSize, "field"),
            annotation="Width of image to create",)
        self.uiFourView_Height = mUI.MelIntField(
            _row,
            minValue=32,
            value=1024,
            changeCommand=cgmGEN.Callback(self.uiFunc_setSize, "field"),
        ...
        mUI.MelLabel(_row, l="ControlNet Generate Image:", align="right")
        
        self.fourViewGenerateBt = cgmUI.add_Button(
            _row, "Generate Four-View Image",
            cgmGEN.Callback(ocgt.generateFourViewImage, self))
        mUI.MelSpacer(_row, w=5)
        _row.layout()
        
        
        #Bake And Merge button
        _row = mUI.MelHSingleStretchLayout(_inside, expand=True, ut="cgmUISubTemplate")
        mUI.MelSpacer(_row, w=5)
        mUI.MelLabel(_row, l="Bake Projection Seperately:", align="right")
        _row.setStretchWidget(mUI.MelSeparator(_row, w=2))  
        self.bakeAndProjectionBt = cgmUI.add_Button(
            _row, 
            "Projection And Merge", 
            lambda *a: self.unFunc_BakeAndMerge())   
        mUI.MelSpacer(_row, w=5)
        _row.layout()   
    ...
    def buildColumn_edit(self, parent, asScroll=True, inside=None):
        ...
        for n, i in enumerate(num_inputs or []):
            ...
            _thumbSize = (150, 150)  # size of image preview in edit menu
    ...
    # >> Latent Space 
    # =============================================================================================================
    def uiFunc_getLatentDepthMap(self):
        ocgt.getLetentDepthMap(self)
        
        
    def uiFunc_generateImage(self):
        ocgt.generateImage(self)
    
    def unFunc_BakeAndMerge(self):
        ocgt.BakeAndMerge(self)
...
def uiFunc_oneClickGenerate():
        ocgt.latent_space_projection_bake